// This file is from the preact github repo: https://github.com/preactjs/preact
...
export interface SemanticsMathMLAttributes<T extends EventTarget>
	extends MathMLAttributes<T> {}
// These Intrinsic tyeps are from the preact github repo: https://github.com/preactjs/preact
...
export interface IntrinsicHTMLElements {
	a: AccessibleAnchorHTMLAttributes<HTMLAnchorElement>;
	abbr: HTMLAttributes<HTMLElement>;
	address: HTMLAttributes<HTMLElement>;
	area: AccessibleAreaHTMLAttributes<HTMLAreaElement>;
	...
	img: AccessibleImgHTMLAttributes<HTMLImageElement>;
	input: AccessibleInputHTMLAttributes<HTMLInputElement>;
	...
	select: AccessibleSelectHTMLAttributes<HTMLSelectElement>;
